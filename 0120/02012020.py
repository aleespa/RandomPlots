...
for p in list(range(1,50))+[500]:
    ...
    plt.plot([-(1-x**p)**(1/p) for x in np.linspace(0,1,800)],np.linspace(0,-1,800),lw=3,color=colors[p])
plt.savefig(f'C:/Users/Alejandro/Pictures/RandomPlots/02012020/02012020_{1}.png',facecolor='black')
...
plt.savefig(f'C:/Users/Alejandro/Pictures/RandomPlots/02012020/02012020_{2}.png',facecolor='black')
...
plt.savefig(f'C:/Users/Alejandro/Pictures/RandomPlots/02012020/02012020_{3}.png',facecolor='black')
...
plt.savefig(f'C:/Users/Alejandro/Pictures/RandomPlots/02012020/02012020_{4}.png',facecolor='black')