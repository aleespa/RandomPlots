...
for j,z in enumerate(np.linspace(0,2*pi,210)):
    ...
    for i,t in enumerate(np.linspace(0,2*pi,50)):
        plt.plot([0,cos(t),cos(z)],[0,sin(t),sin(z)],color=colors[i],lw=3.5,alpha=0.75)

    p = plt.savefig(f'C:/Users/Alejandro/Pictures/RandomPlots/16042020/plot{j}.PNG',facecolor='black')